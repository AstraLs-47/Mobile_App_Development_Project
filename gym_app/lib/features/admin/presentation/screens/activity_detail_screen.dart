...
class ActivityDetailScreen extends StatelessWidget {
  ...
  Map<String, dynamic> _getWorkoutDetails() {
    ...
    if (!presets.contains(title)) {
      ...
      if (activity['coolDown'] != null && activity['coolDown']!.isNotEmpty) {
        customSections.add({
          'title': '🧘 Cool Down',
          'content': activity['coolDown'],
        });
      }
  ...
  void _showEditDialog(BuildContext context) {
    ...
    String category = activity['category'] ?? 'Cardio';
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        items: ['Cardio', 'Strength', 'Aerobics'].map((
                          String value,
                        ) {
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Hero(
                ...
                child:
                    (activity['image'] != null && activity['image']!.isNotEmpty)
                    ? (activity['image']!.startsWith('assets/')
                          ? Image.asset(
                              activity['image']!,
                              fit: BoxFit.cover,
                          ...
                          : ((kIsWeb ||
                                    ...
                                    activity['image']!.startsWith('blob:'))
                                ? Image.network(
                                    activity['image']!,
                                    fit: BoxFit.cover,
                                    alignment: imageAlignment,
