...
class _AdminActivitiesScreenState extends State<AdminActivitiesScreen> {
  ...
  void _addActivity(Activity activity) async {
    await _exerciseService.addActivity(activity);
    _refreshActivities();
  }
  ...
  void _showAddCategoryDialog() {
    ...
    showDialog(
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setDialogState) {
            final currentCategories = MockDB().categories;
            return Dialog(
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(24),
              ),
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              if (newCategory.isNotEmpty) {
                                MockDB().addCategory(newCategory);
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Activity>>(
        ...
        builder: (context, snapshot) {
          ...
          final categories = ['All', ...MockDB().categories];
