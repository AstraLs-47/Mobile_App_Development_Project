                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<String>(
                                  value:
                                      ...
                                      ? MockDB().productCategories.firstWhere(
                                          (c) =>
                                              c.toLowerCase() ==
                                              selectedCat.toLowerCase(),
                                        )
                                      : MockDB().productCategories.first,
                                  isExpanded: true,
                                  icon: const Icon(
                                  ...
                                  items: MockDB().productCategories.map((
                                    String value,
                                  ) {
  ...
  void _showAddCategoryDialog() {
    ...
    showDialog(
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setDialogState) {
            final currentCategories = MockDB().productCategories;
            return Dialog(
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(24),
              ),
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              if (newCategory.isNotEmpty) {
                                MockDB().addProductCategory(newCategory);
                              ...
                              child: Row(
                                children: [
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      MockDB().removeProductCategory(cat);
                                      setDialogState(() {});
                                      setState(() {});
                                    },
