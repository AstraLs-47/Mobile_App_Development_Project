...
class _UserInfoPageState extends State<_UserInfoPage> {
  ...
  void _validateAndProceed() {
    ...
    AuthService.birthDate = _birthController.text;
    AuthService.height = _heightController.text;
    AuthService.weight = _weightController.text;
    AuthService.goalWeight = _goalWeightController.text;
