            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton.icon(
                    ...
                    label: const Icon(Icons.logout, color: Color(0xFF64748B), size: 18),
                  ),
                ],
              ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black.withOpacity(0.12), // Stronger shadow for visibility
                      blurRadius: 20,
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.email_outlined, color: Color(0xFF0E6CF2), size: 20),
                        ),
