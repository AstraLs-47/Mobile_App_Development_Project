              ...
              child: _selectedTab == 0 
                ? FutureBuilder<List<WorkoutEntry>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return logs.isEmpty ? _buildEmptyWorkoutLog() : _buildProgressList(logs);
                    },
                  )
                : HealthMetricsTab(),
            ),
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: isSelected ? [
              BoxShadow(
                color: const Color(0xFF0E6CF2).withOpacity(0.2),
                blurRadius: 8,
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () async {
                    await context.pushNamed(RouteConstants.trackingEditName, extra: entry);
                    _refreshLogs();
                  },
                ),
                IconButton(
            ...
            children: [
              ...
              Expanded(
                child: ElevatedButton(
                  ...
                  child: const Text('No', style: TextStyle(color: Color(0xFF4B5563))),
                ),
              ),
            ],
          ),
